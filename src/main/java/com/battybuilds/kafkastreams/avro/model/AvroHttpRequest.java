...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public com.battybuilds.kafkastreams.avro.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.battybuilds.kafkastreams.avro.model.ClientIdentifier value) {
   ...
   */
  public static com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder newBuilder() {
    return new com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder newBuilder(com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder other) {
    return new com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder newBuilder(com.battybuilds.kafkastreams.avro.model.AvroHttpRequest other) {
    return new com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.battybuilds.kafkastreams.avro.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.battybuilds.kafkastreams.avro.model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder setClientIdentifier(com.battybuilds.kafkastreams.avro.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.battybuilds.kafkastreams.avro.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.battybuilds.kafkastreams.avro.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.battybuilds.kafkastreams.avro.model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.battybuilds.kafkastreams.avro.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.battybuilds.kafkastreams.avro.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
